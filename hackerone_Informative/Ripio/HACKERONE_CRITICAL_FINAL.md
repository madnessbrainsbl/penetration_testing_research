...
[Attached: Network tab showing Referer header with full JWT token]
...
- **2025-12-02**: Same-origin Referer leak confirmed
- **2025-12-02**: Full PoC developed
...
1. Screenshot: Network tab showing Referer with full JWT token
2. Screenshot: API response with stolen token (user data)
3. Screenshot: CSS injection visual proof (red background)
4. HAR file: Full network capture (optional)
